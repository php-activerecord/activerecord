...
class Model
{
    ...
    public function assign_attribute($name, $value)
    {
        ...
        if ($value instanceof \DateTime) {
            ...
            if (!$value instanceof $date_class) {
                $value = $date_class::createFromFormat(Connection::DATETIME_TRANSLATE_FORMAT, $value->format(Connection::DATETIME_TRANSLATE_FORMAT), $value->getTimezone());
            }
        }
     ...
     */
    public static function is_options_hash(array $array, $throw = true)
    {
        if (is_hash($array)) {
