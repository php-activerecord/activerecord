...
abstract class Connection
{
     ...
     * @var array
     */
    public static $PDO_OPTIONS = [PDO::ATTR_CASE => PDO::CASE_LOWER, PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION, PDO::ATTR_ORACLE_NULLS => PDO::NULL_NATURAL, PDO::ATTR_STRINGIFY_FETCHES => false];
    /**
    ...
    {
        return $string[0] === static::$QUOTE_CHARACTER || $string[strlen($string) - 1] === static::$QUOTE_CHARACTER ? $string : static::$QUOTE_CHARACTER . $string . static::$QUOTE_CHARACTER;
    }
    /**
     ...
     */
    public abstract function limit($sql, $offset, $limit);
    /**
     ...
     * @return PDOStatement
     */
    public abstract function query_column_info($table);
    /**
     ...
     * @return PDOStatement
     */
    public abstract function query_for_tables();
    /**
     ...
     */
    public abstract function native_database_types();
    /**
