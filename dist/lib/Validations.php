...
class Validations
{
    ...
    private $validators = [];
    private $record;
    private static $VALIDATION_FUNCTIONS = ['validates_presence_of', 'validates_size_of', 'validates_length_of', 'validates_inclusion_of', 'validates_exclusion_of', 'validates_format_of', 'validates_numericality_of', 'validates_uniqueness_of'];
    private static $DEFAULT_VALIDATION_OPTIONS = ['on' => 'save', 'allow_null' => false, 'allow_blank' => false, 'message' => null];
    private static $ALL_RANGE_OPTIONS = ['is' => null, 'within' => null, 'in' => null, 'minimum' => null, 'maximum' => null];
    private static $ALL_NUMERICALITY_CHECKS = ['greater_than' => null, 'greater_than_or_equal_to' => null, 'equal_to' => null, 'less_than' => null, 'less_than_or_equal_to' => null, 'odd' => null, 'even' => null];
    /**
    ...
    {
        $configuration = array_merge(self::$DEFAULT_VALIDATION_OPTIONS, ['message' => Errors::$DEFAULT_ERROR_MESSAGES['unique']]);
...
class Errors implements IteratorAggregate
{
    private $model;
    private $errors;
    public static $DEFAULT_ERROR_MESSAGES = ['inclusion' => 'is not included in the list', 'exclusion' => 'is reserved', 'invalid' => 'is invalid', 'confirmation' => "doesn't match confirmation", 'accepted' => 'must be accepted', 'empty' => "can't be empty", 'blank' => "can't be blank", 'too_long' => 'is too long (maximum is %d characters)', 'too_short' => 'is too short (minimum is %d characters)', 'wrong_length' => 'is the wrong length (should be %d characters)', 'taken' => 'has already been taken', 'not_a_number' => 'is not a number', 'greater_than' => 'must be greater than %d', 'equal_to' => 'must be equal to %d', 'less_than' => 'must be less than %d', 'odd' => 'must be odd', 'even' => 'must be even', 'unique' => 'must be unique', 'less_than_or_equal_to' => 'must be less than or equal to %d', 'greater_than_or_equal_to' => 'must be greater than or equal to %d'];
    /**
