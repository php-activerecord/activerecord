...
class OciAdapter extends Connection
{
    ...
    public function limit($sql, $offset, $limit)
    {
        ...
        return "SELECT * FROM (SELECT a.*, rownum ar_rnum__ FROM ({$sql}) a " . "WHERE rownum <= {$stop}) WHERE ar_rnum__ > {$offset}";
    }
    ...
    {
        return ['primary_key' => 'NUMBER(38) NOT NULL PRIMARY KEY', 'string' => ['name' => 'VARCHAR2', 'length' => 255], 'text' => ['name' => 'CLOB'], 'integer' => ['name' => 'NUMBER', 'length' => 38], 'float' => ['name' => 'NUMBER'], 'datetime' => ['name' => 'DATE'], 'timestamp' => ['name' => 'DATE'], 'time' => ['name' => 'DATE'], 'date' => ['name' => 'DATE'], 'binary' => ['name' => 'BLOB'], 'boolean' => ['name' => 'NUMBER', 'length' => 1]];
    }
}